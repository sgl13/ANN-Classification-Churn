...
The project is based on the classic `Churn_Modelling.csv` bank customer dataset. It demonstrates two complementary deep learning tasks on the same dataset:
...
- Data-driven HR/finance salary estimation use cases
...
Screenshots for both applications are also available directly in the repository:

- `Screenshot_ann_Classification/` — Churn Classification app screenshots
